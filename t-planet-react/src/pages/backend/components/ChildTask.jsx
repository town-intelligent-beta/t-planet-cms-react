...
import { submitTask, deleteTask } from "../../../utils/Task";
import { useParams, useLocation } from "react-router-dom";
import SdgsModal from "../../../utils/sdgs/SdgsModal";

const TaskBlock = ({ task, updateTask, removeTask, taskId }) => {
...
const ChildTaskBlock = ({ AllChildTasks, setAllChildTasks }) => {
  const { id } = useParams();
