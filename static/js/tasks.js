  ...
  prepare_task_cover_upload()
    .then(async function () {
      var coverImg = document
        .getElementById("coverImg_" + uuid_task)
...
export function child_task_submit(page) {
  ...
  if (getLocalStorage("child_task_queue") == "") return;
  ...
  for (
    var index_child_task = 0;
    index_child_task < child_task_queue.length;
    index_child_task++
  ) {
    ...
    form.append(
      "name",
      document.getElementById("name_" + child_task_queue[index_child_task])
        .value
    );
    form.append(
      "task_start_date",
      document.getElementById(
        "task_start_date_" + child_task_queue[index_child_task]
      ).value
    );
    form.append(
      "task_due_date",
      document.getElementById(
        "task_due_date_" + child_task_queue[index_child_task]
      ).value
    );
